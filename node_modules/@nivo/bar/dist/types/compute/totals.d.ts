...
export declare const computeBarTotals: <RawDatum extends BarDatum>(bars: ComputedBarDatum<RawDatum>[], xScale: ScaleBand<string> | AnyScale, yScale: ScaleBand<string> | AnyScale, layout: "horizontal" | "vertical" | undefined, groupMode: "grouped" | "stacked" | undefined, totalsOffset: number, formatValue: (value: number) => string) => BarTotalsData[];
