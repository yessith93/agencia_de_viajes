/**
 * v0 by Vercel.
 * @see https://v0.dev/t/Q5KWw8hWlt3
    ...
    <div className="grid min-h-screen w-full grid-cols-[280px_1fr] overflow-hidden">
      ...
      <div className="flex flex-col">
                ...
                <DropdownMenuItem>
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">Your order #12345 has been placed.</p>
                    </div>
                  </div>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">Welcome, Jane Doe!</p>
                    </div>
                  </div>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <div className="flex items-center gap-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-yellow-100 dark:bg-yellow-900">
                      <CircleAlertIcon className="h-5 w-5 text-yellow-500 dark:text-yellow-400" />
                    </div>
                    <div className="flex-1">
                      <p className="text-sm font-medium">Payment due</p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        Your payment for invoice #54321 is due in 3 days.
                      </p>
                    </div>
                  </div>
                </DropdownMenuItem>
        ...
        <main className="flex-1 p-4 md:p-6">
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
